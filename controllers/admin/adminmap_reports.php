...
class Adminmap_reports_Controller extends Admin_Controller
{
    ...
    */
	...
	$reports_count = count(adminmap_reports::get_reports_list_by_cat($category_ids, $approved_text . ' '. $location_where. " AND ". $filter, $logical_operator));
	...
	$is = adminmap_reports::get_reports_list_by_cat($category_ids,  $approved_text . ' '. $location_where. " AND ". $filter, $logical_operator, 
	...
	foreach($is as $i)
	{
		$incidents = $incidents->orwhere("id", $i->id);
	}
