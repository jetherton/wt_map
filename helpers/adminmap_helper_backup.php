	...
	$link_target = "_self")
    {
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////////
	        ...
	        while (count($markers))
	        {
	            ...
	            foreach ($markers as $key => $target)
	            {
	                ...
	                if ($pixels < $distance AND ($marker->province_cat == $target->province_cat))
	                {
        ...
        foreach ($clusters as $key=>$cluster)
        {
			...
			*/
            ...
            $json_item .= "\"name\":\"" . str_replace(chr(10), ' ', str_replace(chr(13), ' ', "<a target='".$link_target."' href='" . url::base() . $list_reports_path. $url_param_join_character . $categories_str."&sw=".$southwest."&ne=".$northeast."&lo=".$logical_operator."&u=".$show_unapproved.$time_filter."&dm=".$province_id."'>" . $cluster_count . " Reports<br/> In ".$province_name."</a> ".$category_str)) . "\",";
