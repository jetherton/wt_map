		...
		*/
			...
			north,east,south,west)
		{
			...
			*/
			...
			{
				fetchUrl = protocolUrl;
			}
			else
			{
			 
				fetchUrl = protocolUrl + '?z=' + myZoom + '&' + this.markerUrlParams(startDate, endDate).join('&') + "&u="+currStatus + "&uc="+currColorStatus
					+ "&lo="+currLogicalOperator;
				
				//if the north bound isn't null
				if(north != null)
				{
					fetchUrl += "&north="+north+"&east="+east+"&south="+south+"&west="+west;
				}
			}
